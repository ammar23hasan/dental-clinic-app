          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _buildSocialButton(
                ...
                onPressed: () {
                  _showNotAvailable(context, 'Google sign-in is not configured yet.');
                },
              ...
              _buildSocialButton(
                ...
                icon: Icons.apple,
                onPressed: () {
                  _showNotAvailable(context, 'Apple sign-in is not configured yet.');
                },
                backgroundColor: const Color(0xFFF0F0F0),
                textColor: Colors.black,
              ),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        TextButton(
                          onPressed: () {
                            _showNotAvailable(context, 'Terms of Service are not available yet.');
                          },
                          child: const Text(
                            'Terms of Service',
                            style: TextStyle(
